...
test("August 5 Research News contains one new paper and one clearly labeled multi-vendor product report", () => {
  const entries = getResearchPapers("en").filter((paper) => paper.createdAt === "2026-08-05");
...
test("August 5 entries use two unique master visuals across four id-aligned paths and two complete static narrations", () => {
  const entries = getResearchPapers("en").filter((paper) => paper.createdAt === "2026-08-05");

...
test("August 4 Research News contains one new paper and one clearly labeled multi-vendor product report", () => {
  const entries = getResearchPapers("en").filter((paper) => paper.createdAt === "2026-08-04");
...
test("August 4 entries use two unique master visuals across four id-aligned paths and two complete static narrations", () => {
  const entries = getResearchPapers("en").filter((paper) => paper.createdAt === "2026-08-04");

...
const baseDictionaries: Record<Locale, BaseDictionary> = {
  ...
  "zh-hant": {
    ...
    nav: { home: "首頁", mission: "使命", researchNews: "新聞", about: "關於", menu: "選單", close: "關閉" },
    common: {
      language: "語言",
      learnMore: "了解更多",
  ...
  "zh-hans": {
    ...
    nav: { home: "首页", mission: "使命", researchNews: "新闻", about: "关于", menu: "菜单", close: "关闭" },
    common: {
      language: "语言",
      learnMore: "了解更多",
  ...
  es: {
    ...
    nav: { home: "Inicio", mission: "Misión", researchNews: "Noticias", about: "Acerca de", menu: "Menú", close: "Cerrar" },
...
const fallbackLocalizedCopy: Record<Exclude<Locale, "en" | "zh-hant" | "zh-hans" | "es">, LocalizedBaseInput> = {
  fr: {
    ...
    nav: ["Accueil", "Mission", "Actualités", "À propos", "Menu", "Fermer"],
  ...
  pt: {
    ...
    nav: ["Início", "Missão", "Notícias", "Sobre", "Menu", "Fechar"],
  ...
  de: {
    ...
    nav: ["Start", "Mission", "Nachrichten", "Über uns", "Menü", "Schließen"],
  ...
  ar: {
    ...
    nav: ["الرئيسية", "المهمة", "الأخبار", "حول", "القائمة", "إغلاق"],
  ...
  ja: {
    ...
    nav: ["ホーム", "ミッション", "ニュース", "概要", "メニュー", "閉じる"],
  ...
  hi: {
    ...
    nav: ["होम", "मिशन", "समाचार", "परिचय", "मेनू", "बंद करें"],
  ...
  ru: {
    ...
    nav: ["Главная", "Миссия", "Новости", "О проекте", "Меню", "Закрыть"],
  ...
  id: {
    ...
    nav: ["Beranda", "Misi", "Berita", "Tentang", "Menu", "Tutup"],
  ...
  bn: {
    ...
    nav: ["হোম", "মিশন", "সংবাদ", "পরিচিতি", "মেনু", "বন্ধ করুন"],

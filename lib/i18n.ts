...
const enDictionary = {
  ...
  research: {
    ...
    title: "AIED papers, summarized for research-to-product translation.",
    intro:
...
export type Dictionary = DeepWiden<typeof enDictionary>;
...
function makeRomanceDictionary(locale: Exclude<Locale, "en" | "zh-hant" | "zh-hans" | "es">): Dictionary {
...
type LocalizedBaseCopy = { metaDescription: string } & Omit<Dictionary, "meta">;
...
const strategyTranslations: Record<string, Dictionary["mission"]["strategies"]> = {
...
const logoConceptTranslations: Record<string, Dictionary["logoConcepts"]["concepts"]> = {
...
const localizedNewsletterCopy: Record<string, Dictionary["research"]["newsletter"]> = {
...
for (const locale of ["fr", "pt", "de", "ar", "ko", "ja", "hi", "ru", "id", "bn"] as const) {
  dictionaries[locale] = makeRomanceDictionary(locale);
}
